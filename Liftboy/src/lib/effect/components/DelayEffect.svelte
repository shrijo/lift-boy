<script lang="ts">
  ...
  // Create visual representation of delay
  $: timePercent = ($delayTime / 2) * 100;
  $: feedbackPercent = $delayFeedback * 100;
  $: mixPercent = $delayMix * 100;
</script>
      ...
      <div class="visual-wrapper">
        <div class="visual">
          <div class="param-display">
            ...
            <div class="bar">
              <div class="fill" style={`width: ${timePercent}%;`}></div>
            </div>
          </div>
          <div class="param-display">
            <div class="label">FEEDBACK</div>
            <div class="bar">
              <div class="fill" style={`width: ${feedbackPercent}%;`}></div>
            </div>
          </div>
          <div class="param-display">
