<script lang="ts">
    ...
    import { currentSection, currentSlideIndex } from './stores/navigation';
    import type { SlideInput, SectionKind } from './types';
    import type { StepState } from './stores/sequencer';
    import type { BarState } from './stores/melody';
    import type { SynthState } from './stores/synth';
    import {
        activeStep,
        selectedStep,
        patternLength,
    ...
    $: isActive = $currentSection === sectionIndex && $currentSlideIndex === slideIndex;
    ...
    function formatDisplay(
        ...
        const { xox, melody, synth } = context;
