<script lang="ts">
  ...
  import { congaSettings } from '../stores/conga';
    ...
    <div class="slide" aria-label={slide.title ?? `Page ${index + 1}`} data-index={index}>
      <div class="drum-label">
        ...
        <div class="params-display">
          <div class="param">Pitch: {settings.pitch}Hz</div>
          <div class="param">Pitch Decay: {settings.pitchDecay.toFixed(2)}s</div>
